    ...
    <header className="grid grid-flow-col place-content-between lg:place-content-around select-none shadow-lg sticky top-0 bg-light-gray z-10">
      ...
      <nav className="grid place-items-center">
        <section className="lg:hidden">
          ...
          {isNavOpen && (
            <div className={`absolute w-full h-screen top-0 left-0 bg-light-gray z-10 grid place-content-center ${isClosing ? 'animate-menu-out' : 'animate-menu-in'}`}>
              <div
              ...
              <ul className="grid grid-flow-row place-items-center sm:grid-flow-col gap-12 sm:gap-8 min-h-[250px] uppercase">
                ...
                <li>
                  <NavLink to='/edital' className={({isActive}) => ( isActive ? 'link-custom after:animate-link-animate' : '')} onClick={handleCloseMenu}>Edital</NavLink>
                </li>
                <li>
                  <NavLink to='/avisos' className={({isActive}) => ( isActive ? 'link-custom after:animate-link-animate' : '')} onClick={handleCloseMenu}>Avisos</NavLink>
                </li>
                <li>

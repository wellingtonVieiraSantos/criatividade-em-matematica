...
const PageNotFound = () => {
  return (
    <section className='w-screen h-dvh grid place-items-center bg-light-gray p-1'>
      <div className='w-full max-w-lg p-5 grid place-items-center gap-5 text-center'>
        <header>
          <h1 className='text-9xl font-calibri bg-linear-to-r from-terciary to-secondary bg-clip-text text-transparent'>
            404
          </h1>
        </header>
        <p className='text-lg text-center'>Erro 404. Página não encontrada.</p>

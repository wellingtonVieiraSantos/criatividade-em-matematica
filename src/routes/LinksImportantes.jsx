  ...
  return (
    <section className="min-h-[calc(100vh-7rem)] xl:w-[1280px] m-auto grid place-items-center">
      ...
      <div className="grid grid-flow-row place-items-center gap-10 my-5">
        <a href="https://forms.gle/E5yGCoZ9V1wxzrSu6" target='_blank' className="text-coral font-bold hover:underline w-full sm:w-72 py-4 px-8 sm:px-0 rounded-full ring ring-coral grid grid-flow-col place-content-evenly gap-2 sm:gap-0 text-lg shadow-lg uppercase">

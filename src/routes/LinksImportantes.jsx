    ...
    <section className='min-h-[calc(100vh-7rem)] xl:w-[1280px] m-auto grid place-items-center'>
      ...
      <div className='grid grid-flow-row place-items-center gap-10 my-5'>
        ...
        <a
          ...
          target='_blank'
          className='text-coral font-bold hover:underline w-full sm:w-72 py-4 px-8 sm:px-0 rounded-full ring ring-coral grid grid-flow-col place-content-evenly text-lg shadow-lg'
        >
        ...
        <a
          ...
          target='_blank'
          className='text-coral font-bold hover:underline w-full sm:w-72 py-4 px-8 sm:px-0 rounded-full ring ring-coral grid grid-flow-col place-content-evenly text-lg shadow-lg uppercase'
        >

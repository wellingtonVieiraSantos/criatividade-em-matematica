  ...
  return (
    <div className="min-h-[calc(100vh-11rem)] xl:w-[1280px] m-auto mb-10 text-justify leading-loose p-3 divide-y-2 divide-terciary divide-dashed">
      <section className="my-10">
        ...
        <p><strong>Inscripciones:</strong> <a href="https://forms.gle/E5yGCoZ9V1wxzrSu6" target="_blank" className="text-coral font-bold hover:underline">Inscripción</a></p>

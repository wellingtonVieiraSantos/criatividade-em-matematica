  ...
  return (
    <div className="min-h-[calc(100vh-11rem)] xl:w-[1280px] m-auto mb-10 text-justify leading-loose p-3 divide-y-2 divide-terciary divide-dashed">
      <section className="my-10">
        <header>
          <img src={argentina} alt="bandera de argentina" width={96} height={96} className="h-24"/>
          <h1 className="text-xl lg:text-4xl text-center my-10 text-primary">Invitación para Formación en Creatividad en Matemática a través de Problemas Abiertos (Argentina)</h1>
        </header>
        <p>Este documento tiene como objetivo regular el proceso de selección de los cursantes que integrarán el grupo de profesores y profesoras argentinos para la formación en Creatividad en Matemática a través de Problemas Abiertos. La formación será semipresencial y gratuita, promovida por la Universidad Estatal del Oeste de Paraná (Unioeste), Campus Cascavel, el Instituto Federal de Brasília (IFB), Campus Planaltina, y la Universidad Nacional de Rosario (UNR), Facultad de Ciencias Exactas, Ingeniería y Agrimensura.</p>
        <p><strong>Público objetivo:</strong> Profesores y profesoras, en ejercicio, que enseñan Matemática en el nivel secundario, formadores de profesores, y estudiantes avanzados de Profesorado en Matemática.</p>
        <p><strong>Período de realización del curso:</strong> Clases presenciales en octubre (en Av. Pellegrini 250, FCEIA-UNR, Rosario, Argentina) y clases online sincrónicas en noviembre, del 03/10 al 28/11. ¡Todos los jueves! De 13:00 a 16:00 h.</p>
        <p><strong>Modalidad del curso:</strong> Semipresencial, con 5 encuentros presenciales y 4 encuentros online sincrónicos a través de la plataforma nead.ifb.edu.br.</p>
        <p><strong>Créditos:</strong> 56 horas reloj con evaluación.</p>
        <p><strong>Cupos disponibles:</strong> 20.</p>
        <p><strong>Inscripciones:</strong> <a href="#" target="_blank" className="text-coral font-bold hover:underline">Inscripción (encerrado)</a></p>
        <p>El formulario se abrirá el 20 de septiembre de 2024 a las 13:00 h y estará disponible hasta el 27 de septiembre de 2024 a las 23:00 h. La selección se realizará según el orden de inscripción registrado por el propio sistema. Si los cupos se completan antes de la fecha límite, el formulario será cerrado.</p>
        <h2 className="text-xl font-bold my-4">Contenido Programático:</h2>
        <p>Reflexiones Teórico-Prácticas en torno a:</p>
        <ol className="list-decimal list-inside space-y-4">
          <li><strong>La creatividad en una primera mirada:</strong> Introducción a la importancia e impacto de la creatividad; Wallas y el Pensamiento Creativo; Guilford y los Pensamientos Convergente y Divergente; Fluidez, Flexibilidad, Originalidad y Elaboración; Torrance, el padre de la Investigación en Creatividad; Novaes y la Psicología de la Creatividad.</li>
          <li><strong>La creatividad a través de problemas abiertos:</strong> El “sumatorio de Gauss”; Alencar, Creatividad y Enseñanza; Escuelas creativas.</li>
          <li><strong>La Creatividad en Matemática:</strong> Conceptos de Creatividad en Matemática; La fórmula de Ofili; Investigaciones en Creatividad en Matemática; El Modelo de los Cuatro C de Kaufman y Beghetto.</li>
          <li><strong>La Creatividad Docente:</strong> Enseñar creativamente y enseñar para la creatividad; Evaluación y Creatividad en Matemática; La Creatividad Docente; Reflexiones teórico-prácticas autónomas; Prácticas en creatividad en matemática.</li>
        </ol>
      </section>
      <section className="my-10">
        <header>
        ...
        <ol className="list-decimal list-inside space-y-4">
          ...
          <li><strong>Processo de solicitação de inscrição</strong>
            <p>Para se candidatar a uma vaga no curso, os interessados e interessadas deverão preencher um formulário online com sua solicitação. Esse formulário estará disponível somente em 1º de Setembro de 2024 (domingo) das 13:00 h às 23:59 h (horário de Brasília). Os interessados e interessadas deverão acessar o formulário disponível em: <a href="#" target="_blank" className="text-coral font-bold hover:underline">Inscreva-se! (encerrado)</a> e preencher os seguintes campos: nome, CPF, data de nascimento, Região, estado, <span translate='no'> e-mail</span>, turma de preferência e o Termo de Consentimento Livre e Esclarecido (TCLE) aceitando participar da pesquisa a qual se racionada esta formação: abordagens criativas através de problemas abertos nos processos de formação com professores de matemática, caso o candidato não esteja de acordo com a participação, deverá esperar uma nova convocatória, sem data definida. Por último o candidato deverá clicar em ENVIAR para que sua solicitação de inscrição seja registrada no sistema online.</p>
            <p>Os candidatos receberão um <span translate='no'> e-mail </span> com confirmação da solicitação de inscrição no prazo máximo de 24 horas, contado do momento da conclusão de sua solicitação de inscrição.

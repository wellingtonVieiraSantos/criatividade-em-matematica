...
const Edital = () => {
  return (
    <div className="min-h-[calc(100vh-11rem)] xl:w-[1280px] m-auto mb-10 text-justify leading-loose p-3">
      <h1 className="text-xl lg:text-4xl text-center my-10 text-primary">Chamada para a 1ª Edição da Formação em Criatividade em Matemática através de Problemas Abertos</h1>
      ...
      <ol className="list-decimal list-inside space-y-4">
        ...
        <li><strong>Modalidade do Curso:</strong> A distância e gratuito via planatorma <a href="https://nead.ifb.edu.br/" target="_blank" className="text-coral font-bold hover:underline">nead.ifb.edu.br</a>.</li>

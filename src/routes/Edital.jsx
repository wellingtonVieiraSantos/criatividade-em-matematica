    ...
    <div className="w-screen xl:w-[1280px] m-auto px-2">
      <div className="text-justify leading-loose">
        ...
        <ol className="list-decimal list-inside space-y-4">
          ...
          <li><strong>Modalidade do Curso:</strong> A distância e gratuito via planatorma <a href="https://nead.ifb.edu.br/" target="_blank" className="text-[#00AEED] font-bold hover:underline">nead.ifb.edu.br</a>.</li>
          <li><strong>Carga horária </strong>
            ...
            <table className="table-auto my-4 divide-y m-auto">
              <thead>
                <tr>
        ...
        <p>As vagas descritas no item 5 serão preenchidas obedecendo a ordem cronológica de inscrição dos candidatos e obedecendo o estado preenchido no formulário de inscrição.</p>
        ...
        <p>Até às 23h59min (horário de Brasília) de 05 de setembro de 2024 (segunda-feira), será disponibilizada, no site [Em construção], uma lista dos candidatos inscritos na 1ª Edição edição da Formação em Criatividade em Matemática através de Problemas Abertos, e, também, uma lista de candidatos da lista de espera. Os inscritos serão considerados cursistas desta formação após realizarem seu primeiro acesso ao sistema online, e o prazo máximo para esse acesso encerra às 23h59min (horário de Brasília) de 09 de setembro de 2024 (segunda-feira). Para acessar o sistema online, os inscritos receberão, via e-mail, informações de como cadastrar um usuário e senha. Em caso de não recebimento dos dados de acesso, o candidato deverá solicitar seus dados enviando e-mail para <a href="mailto:henio.oliveirsa@ifb.edu.br" target="_blank" className="text-[#00AEED] font-bold hover:underline">henio.oliveira@ifb.edu.br</a> dentro do prazo previsto para a confirmação das inscrições.  Não havendo o primeiro acesso ao sistema online do curso até a data prevista anteriormente, o candidato perderá sua vaga e a qual será redistribuída aos candidatos da lista de espera, compondo assim uma lista de 2ª chamada.</p>
        <p>A lista de 2ª chamada será divulgada no site [Em construção] até 14h (horário de Brasília) de 12 de setembro de 2024. Os candidatos que comporão essa lista deverão realizar seu primeiro acesso ao sistema online do curso para confirmação da inscrição até às 23h59min (horário de Brasília) de 15 de setembro de 2024 (domingo).</p>
